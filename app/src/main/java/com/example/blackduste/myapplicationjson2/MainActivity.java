...
public class MainActivity extends AppCompatActivity {
    ...
    //  https://newsapi.org/v2/top-headlines?sources=the-hindu&apiKey=c4cf26e89d984cb083184b2a248a2ec5
    ...
    public void btnJsonView(View view) {

        // Creates the Volley request queue
        requestQueue = Volley.newRequestQueue(this);
        MyToastMessage.myMessage(this, "QUEUE Requested");
